 ...
 * Version: 2.7.0
 * Description: Implementação de monitoramento de Power Down (Cores + Coluna Nova)
 */
...
function renderTable() {
  ...
  globalDelegations.forEach((user, index) => {
    ...
    // Se existe data e não é 1969/1970 (data nula do sistema)
    if (pdDate && !pdDate.startsWith("1969") && !pdDate.startsWith("1970")) {
        ownHpStyle = "font-family:monospace; color:#ff4d4d; font-weight:bold;"; // Vermelho Alerta
